        ...
        <div className="footer-main">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://x.com/thecodency?t=idZL_U0P-qkjDcQ0AxVv5w&s=09" className="social-link" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://www.linkedin.com/in/codency-tech-86bb36370?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="social-link" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
